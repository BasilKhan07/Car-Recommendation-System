...
void input(string company, string CarName, string YearReg, string trans, string max_mile, string color)
{
    ...
    cout << endl
         << endl
         << "Showing Results For " << it << " Cars " << endl
         << endl;
    system("pause");
}
...
char Recommend(vector<string> arr)
{
    ...
    cout << endl
    << "Enter Preferred Company: ";
    fflush(stdin);
    getline(cin, comp);
    comp[0] = toupper(comp[0]);

    cout << endl
         << "For 5 seater Car Press 5 - For 7 Seater Car Press 7 - For 2 seater Car press 2 - For 8 seater Car press 8\n";
    cin >> seatChoice;
...
char AddData()
{
    ...
    ofstream file("E://AHSAN//Data Structures//Final Project//cars_data.csv", ios::app);
    ofstream myfile("E://AHSAN//Data Structures//Final Project//newdata.csv", ios::app);
    ...
    file << vin << "," << body_type << "," << city << "," << engineDisplacement << "," << engineType << "," << exteriorColor << "," << fuelType << "," << horsepower << "," << interiorColor << "," << listing_color << ","
    ...
    myfile << vin << "," << body_type << "," << city << "," << engineDisplacement << "," << engineType << "," << exteriorColor << "," << fuelType << "," << horsepower << "," << interiorColor << "," << listing_color << ","
           << main_picture_url << "," << make_name << "," << maximum_seating << "," << mileage << "," << model_name
           << "," << price << "," << transmission << "," << transmission_display << "," << wheel_system << ","
           << wheel_system_display << "," << year << "," << majorOptions << endl;
...
void menu()
{
    cout << endl
         << endl
         << "\t\t\t\t\t\tWelcome To US Used Car Portal" << endl;
    cout << endl
         << "1. Recommendation For Your Car\n2. Search For Specific Car\n3. Add Your Car For Selling\n4. Exit\n\nEnter Your Choice: ";
    int choice;
    cin >> choice;
